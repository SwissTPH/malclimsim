...
```{r}
path_to_SMC <- file.path(path_to_data, "simulated_smc_data_2014_2023.rds")

data("smc_data_raw.rda")

smc_data_raw <- readRDS(path_to_SMC)
...
```{r}
obs_cases <- readRDS(file.path(path_to_data, "simulated_malaria_cases_2018_2023.rds"))
...
control_params_1$n_steps = 15000
...
inf_params_stage_2 <- update_inf_stage(results_obj = mcmc_stage_1,
   ...
   shrink = 0.95, stage = "stage2", n_steps = 15000)
...
inf_params_stage_3 <- update_inf_stage(results_obj = mcmc_stage_2,
   ...
   shrink = 0.8, stage = "noadapt", n_steps = 25000)
